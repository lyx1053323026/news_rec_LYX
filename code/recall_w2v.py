...
class AnnoyIndex:
    """faiss-based AnnoyIndex compatible wrapper"""
    ...
    def get_nns_by_vector(self, query_vec, n, include_distances=False):
...
def word2vec(df_, f1, f2, model_path):
    ...
    tmp.rename(columns={f2: '{}_{}_list'.format(f1, f2)}, inplace=True)
